...
func builtinCommandDescriptors() []CommandDescriptor {
	return []CommandDescriptor{
		...
		{ID: "approve", Name: "approve", Category: CategoryTask, Description: "批准待审批的工具操作", DefaultPermission: PermissionGroupAdmin, Scope: ScopeChat, DefaultEnabled: true},
		{ID: "reject", Name: "reject", Category: CategoryTask, Description: "拒绝待审批的工具操作", DefaultPermission: PermissionGroupAdmin, Scope: ScopeChat, DefaultEnabled: true},
	}
}
